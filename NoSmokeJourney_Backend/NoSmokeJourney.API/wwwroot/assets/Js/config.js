...
const CONFIG = {
  ...
  // URLs — empty string means same-origin (frontend served by ASP.NET Core)
  DEV: {
    API_BASE_URL: ''
  },
  PROD: {
...
// Same-origin setup: frontend and backend served from the same ASP.NET Core server
// No need for absolute URLs — relative paths like /api/... work perfectly
const API_BASE_URL = '';
